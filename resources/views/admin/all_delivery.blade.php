                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="dataTables_length" id="example1_length">
                                ...
                                <tr>
                                    <th>Реден број</th>
                                    <th style="text-align: center">Град за достава</th>
                                    <th style="text-align: center">Цена на достава</th>
                                ...
                                <tr>
                                    <td>{{$delivery->id}}</td>
                                    <td style="text-align: center">{{$delivery->type}}</td>
                                    <td style="text-align: center">{{$delivery->price}}</td>
                                    <td style="text-align: center">
                                        <form class="inline"  action="{{route('edit-delivery',['id'=>$delivery->id])}}">
                                            <button type="submit" class="btn btn-info">Измени</button>
                                        </form>
                                        <form class="inline" action="{{route('delete-delivery',['id'=>$delivery->id])}}">
                                            <a class="btn btn-danger" onclick="return confirm('Дали сте сигурни дека сакате да ја избришите оваа категорија?')" href="{{route('delete-delivery', $delivery->id)}}">Избриши</a>
                                        </form>
                                    </td>
                                </tr>
                                </tbody>
